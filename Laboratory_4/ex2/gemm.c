...
int main(int argc, char *argv[]) {
    ...
    /* EX1: Generate now two square matrices A and B of size (2^n) and fill them with random doubles.
     ...
     */
    double flops_mygemm = 0.0;
    /* |========================================| */
    /* |           Put here your code           | */
    /* |========================================| */
    fprintf(stdout, "My gemm achieved %lf MFLOP/s\n", flops_mygemm / 1.e6);
    return(0);
}
